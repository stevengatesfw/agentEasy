        ...
        if (from_type === 'upload') {
          updateFile({
            ...
            if (shouldNavigateBack) {
              router.push(`/modelAdjust/datasetManager/${id}/${versionId}`)
            }
            else {
              // 刷新当前页面数据
      ...
      <div className={styles.breadcrumb}>
        <Breadcrumb
          items={[
            ...
            {
              title: <Link href='/modelAdjust/datasetManager'>数据集管理</Link>,
            },
            {
              title: <Link href={`/modelAdjust/datasetManager/${id}`}>版本管理</Link>,
            },
            {
              title: <Link href={`/modelAdjust/datasetManager/${id}/${versionId}`}>版本详情</Link>,
            },
            {
              title: 'JSON详情',
            },
