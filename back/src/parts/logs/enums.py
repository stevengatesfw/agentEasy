...
class Action(Enum):
    ...
    # 应用商店操作
    CREATE_APP = "新建智能体"
    CREATE_APP_TMP = "新建智能体"
    CREATE_APP_DSL = "新建智能体"
    DELETE_APP = "删除智能体"
    EXPORT_APP = "导出智能体"
    ADD_TEMPLATE = "添加智能体模板"
    PUBLISH_APP = "发布智能体"
    ENABLE_APP = "启用智能体"
    DISABLE_APP = "禁用智能体"
    DEBUG_APP_OK = "智能体调试"
    DEBUG_APP_FAIL = "智能体调试"
    DEBUG_APP_BATCH = "智能体调试"
    DEBUG_NODE_OK = "智能体调试"
    DEBUG_NODE_FAIL = "智能体调试"
    DEBUG_NODE_BATCH = "智能体调试"
    UPDATE_APP_NODE = "智能体编排"
    UPDATE_APP_RESOURCE = "智能体编排"
